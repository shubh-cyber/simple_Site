        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark navbar-fixed-top">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
              <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="design/about_us.php">About Us</a>
                </li>
                <li class="nav-item">
                    <?php echo'<a class="nav-link" href="design/contact_us.php">Contact Us</a>'; ?>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="design/sign_up.php">Sign Up</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="design/log_in.php">Sign In</a>
                </li>
              </ul>
            </div>
        </nav>
          ...
          <div class="container text-center text-md-left mt-5">
            ...
            <div class="row mt-3">
              ...
              <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
                ...
                <hr class="mb-4 mt-0 d-inline-block mx-auto" style="width: 60px;">
                <p>
                    <a style="color:rgba(255,255,255,0.5)" href="design/about_us.php">About us</a>
                </p>
                <p>
                  <?php echo'<a style="color:rgba(255,255,255,0.5)" href="design/contact_us.php">Contact us</a>'; ?>
                </p>
              </div>
              <!-- Grid column -->
              <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4">
                ...
                <p>
                    <a style="color:rgba(255,255,255,0.5)" href="design/sign_up.php">Sign in</a>
                </p>
                <p>
                    <a style="color:rgba(255,255,255,0.5)" href="design/log_in.php">Sign up</a>
                </p>
              </div>
              <!-- Grid column -->
